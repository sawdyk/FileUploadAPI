...
namespace FileUploadAPI.Repository
{
        ...
        public async Task<FileUploadResponseModel> uploadFilesAsync(FileUploadRequestModel obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    Loggers.WriteToFile($"StatusCode = 200, StatusMessage = Successful,  FileData = {JsonConvert.SerializeObject(fileData)} DateTime: {DateTime.Now}\n");
            ...
            {
                Loggers.WriteToFile($"An Error Occured. Message: {exMessage.Message} StackTrace: {exMessage.StackTrace} DateTime: {DateTime.Now}\n");
